...
public class SecurityConfig {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/auth/logout-all", "/auth/change-password", "/auth/password/change", "/auth/login-devices", "/auth/qr/sessions/*/approve").authenticated()
                        ...
                        // Face authentication endpoints — public (verification handled in service layer)
    ...
    public AuthenticationEntryPoint unauthorizedEntryPoint() {
        return (request, response, authException) -> {
            ...
            response.getWriter().write("{\"success\":false,\"code\":\"ERR_UNAUTHORIZED\",\"message\":\"Unauthorized access\"}");
        };
    }
    ...
    public AccessDeniedHandler accessDeniedHandler() {
        return (request, response, accessDeniedException) -> {
            ...
            response.setContentType(MediaType.APPLICATION_JSON_VALUE);
            response.getWriter().write("{\"success\":false,\"code\":\"ERR_FORBIDDEN\",\"message\":\"Access denied\"}");
        };
    }
}
