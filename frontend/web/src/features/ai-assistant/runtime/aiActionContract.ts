...
export const AI_ACTION_DEFINITIONS: Record<AiActionCommand, AiActionDefinition> = {
  ...
  MUTE_CONVERSATION: { command: 'MUTE_CONVERSATION', label: 'Tắt thông báo cuộc trò chuyện', risk: 'low', capability: 'review', requiresConfirmation: true },
  UNMUTE_CONVERSATION: { command: 'UNMUTE_CONVERSATION', label: 'Bật lại thông báo cuộc trò chuyện', risk: 'low', capability: 'review', requiresConfirmation: true },
