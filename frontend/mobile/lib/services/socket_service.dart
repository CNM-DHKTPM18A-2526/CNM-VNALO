...
class SocketService {
    ...
    final _messageController = StreamController<Message>.broadcast(); // Stream controller for incoming messages
    ...
    _socket = IO.io(
        ...
        IO.OptionBuilder()
            .setTransports(['websocket', 'polling']) // Use the same transports as gateway
    ...
    void sendMessage({required String conversationId, required String content, String messageType = 'TEXT', String? clientMessageId}) {
